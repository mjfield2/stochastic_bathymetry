...
### See our paper published in the journal Geoscientific Model Development

Field, M. J., MacKie, E. J., Wang, L., Muto, A., & Shao, N. (2026). Improved bathymetry estimates beneath Amundsen Sea ice shelves using a Markov Chain Monte Carlo gravity inversion (GravMCMC, version 1). Geoscientific Model Development, 19(4), 1749–1768. https://doi.org/10.5194/gmd-19-1749-2026
...
4. To reproduce the ensembles as presented in the manuscript you can run `sgs_inversions_new.py`. You can specify the number of inversions (-n) and whether or not to apply a lowpass filter to the Bouguer disturbance (-f)
